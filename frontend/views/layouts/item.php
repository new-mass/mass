                ...
                <div class="custom-card_img">
                    <a target="_blank" href="/anketa/<?php echo $item['url'] ?>">
                        ...
                        <picture>
                            ...
                            <img width="255px" height="335px" loading="lazy" class="img-<?php echo $item['id']; ?> img-on-listing" src="<?= Yii::$app->imageCache->thumbSrc($item['avatar']['file'], '255_335') ?>" alt=" <?php echo $item['name'] ?>" title=" <?php echo $item['name'] ?> ">
