...
<header class="main-header">
    <div class="container main-container">
        <div class="row">
            <div class="col-7 col-lg-3 col-md-4 col-sm-5">
                <div class="row">
            ...
            <div class="col-5 col-lg-9 col-md-8 col-sm-7">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-7 col-lg-4 col-md-6 col-sm-8  search-form-wrap">
                    ...
                    <div class="col-12 col-lg-2 col-md-3 col-sm-4 cabinet_a-wrap">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-8 col-sm-12 col-xl-6">
                <div class="row">
                    <div class="col-12">

                        <div class="main-heading" itemscope itemtype="http://schema.org/Product">
                            <h1 itemprop="name"><?php echo Yii::$app->params['meta']['h1']; ?></h1>

                            <meta content="<?php echo Yii::$app->params['meta']['des']; ?>" itemprop="description"><!-- Валюта -->
                            <span itemtype="http://schema.org/AggregateOffer" itemscope="" itemprop="offers">

                                <meta content="5000" itemprop="highPrice"><!-- Высшая цена -->

                                <meta content="2000" itemprop="lowPrice"><!-- Низшая цена -->
            ...
            <div class="col-6 col-md-6 col-lg-4 col-xl-6 new-posts-wrap">
                <div class="new-posts">
                    <div class="row">
                        <div class="col-12">
                            <span class="new-heading">
                                Новые анкеты
                            </span>
                        </div>
                    </div>

                    <div class="new-ankets owl-carousel owl-theme">
